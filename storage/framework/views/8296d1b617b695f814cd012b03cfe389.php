...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    <?php if(auth()->guard()->check()): ?>
      <?php if(auth()->user()->podeAcessar('dashboard')): ?>
      ...
      <?php if(auth()->user()->podeAcessar('usuarios')): ?>
      ...
      <?php if(auth()->user()->podeAcessar('clientes')): ?>
      ...
      <?php if(auth()->user()->podeAcessar('produtos')): ?>
        <a href="<?php echo e(route('produtos.index')); ?>" class="<?php echo e(request()->routeIs('produtos.*') ? 'active' : ''); ?>">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>
          Produtos
        </a>
      <?php endif; ?>

      <?php if(auth()->user()->podeAcessar('receitas')): ?>
        <a href="<?php echo e(route('receitas.index')); ?>" class="<?php echo e(request()->routeIs('receitas.*') ? 'active' : ''); ?>">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
          Receitas
        </a>
      <?php endif; ?>

      <?php if(auth()->user()->podeAcessar('financeiro')): ?>
        <a href="<?php echo e(route('financeiro.index')); ?>" class="<?php echo e(request()->routeIs('financeiro.*') ? 'active' : ''); ?>">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
          Financeiro
        </a>
      <?php endif; ?>

      <?php if(auth()->user()->podeAcessar('relatorios') && Route::has('relatorios.index')): ?>
        <a href="<?php echo e(route('relatorios.index')); ?>" class="<?php echo e(request()->routeIs('relatorios.*') ? 'active' : ''); ?>">
  ...
  <div class="sidebar-footer">
    <?php if(auth()->guard()->check()): ?>
      <div class="user-info">
        <div class="user-avatar"><?php echo e(strtoupper(substr(auth()->user()->nome, 0, 1))); ?></div>
        <div class="user-details">
          <span class="user-name"><?php echo e(auth()->user()->nome); ?></span>
          <span class="user-role"><?php echo e(auth()->user()->perfilLabel()); ?></span>
        </div>
      </div>
...
</aside><?php /**PATH C:\Users\Mariana\Documents\GitHub\Sistema Princípio Ativo - TCC\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>