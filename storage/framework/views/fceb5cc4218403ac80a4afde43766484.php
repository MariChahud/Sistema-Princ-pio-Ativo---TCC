          ...
          <table>
            ...
            <tbody>
              <?php $__empty_1 = true; $__currentLoopData = $produtos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr>
                  <td>
                    <a href="<?php echo e(route('produtos.lotes', $produto)); ?>" class="produto-nome-link" style="font-weight:700;color:var(--primary);text-decoration:none;"><?php echo e($produto->nome); ?></a>
                    <?php if($alerta): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Mariana\Documents\GitHub\Sistema Princípio Ativo - TCC\resources\views/produtos/index.blade.php ENDPATH**/ ?>