  ...
  <header class="header">
    <div class="container header-content">
      <a href="<?php echo e(route('home')); ?>" class="logo">
        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Princípio Ativo" class="logo-img">
        <div class="logo-text">
  ...
  <section class="hero">
    <div class="container">
      <div class="hero-content">
        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Princípio Ativo" class="hero-logo">
        <h1>Sistema de Gestão Farmacêutica</h1>
        <p>Precisão e segurança em cada etapa do processo de manipulação</p>
        <a href="<?php echo e(route('login')); ?>" class="btn btn-primary btn-lg">Acessar Sistema</a>
      </div>
    ...
    <div class="container">
      ...
      <div class="services-grid">
        <?php $__currentLoopData = [
          ...
          ['Relatórios', 'Análises e relatórios detalhados de todas as operações'],
        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$titulo, $desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  <footer class="footer">
    <div class="container">
      ...
      <div class="footer-bottom">
        <p>&copy; <?php echo e(date('Y')); ?> Princípio Ativo - Farmácia de Manipulação. Todos os direitos reservados.</p>
      </div>
    </div>
  </footer>
...
</html><?php /**PATH C:\Users\Mariana\Documents\Faculdade\TCC\AtivoTCC\resources\views\welcome.blade.php ENDPATH**/ ?>