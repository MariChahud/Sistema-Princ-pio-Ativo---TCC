              ...
              <tr>
                ...
                <td class="table-actions">
                  ...
                  <button class="btn btn-sm btn-outline"
                    ...
                    data-payload="<?php echo e(json_encode([
...
<?php $__env->startSection('modais'); ?>
  <div class="modal-overlay" id="receitaModal">
    <div class="modal" style="max-width:600px;">
      ...
      <form id="receitaForm" method="POST" action="<?php echo e(route('receitas.store')); ?>" novalidate>
        <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Mariana\Documents\GitHub\Sistema Princípio Ativo - TCC\resources\views/receitas/index.blade.php ENDPATH**/ ?>