  ...
  <div class="card" style="max-width: 600px; margin: 0 auto; border: 1px dashed var(--border); font-family: monospace;">
    <div class="card-content" style="padding: 2rem;">
      ...
      <div style="font-size: 0.85rem; margin-bottom: 1.5rem; line-height: 1.4;">
        <p style="margin: 0;"><strong>DOC. AUXILIAR DE VENDA:</strong> #<?php echo e(str_pad($transacoes->first()->id, 5, '0', STR_PAD_LEFT)); ?><?php echo e($transacoes->count() > 1 ? ' (+' . ($transacoes->count() - 1) . ')' : ''); ?></p>
        <p style="margin: 0;"><strong>DATA EMISSÃO:</strong> <?php echo e(\Carbon\Carbon::parse($transacoes->first()->data)->format('d/m/Y H:i')); ?></p>
        <p style="margin: 0;"><strong>CLIENTE:</strong> <?php echo e($cliente->nome ?? 'Consumidor Geral'); ?></p>
        <p style="margin: 0;"><strong>CPF:</strong> <?php echo e($cliente->cpf ?? '—'); ?></p>
      </div>
      ...
      <div style="font-size: 0.85rem; margin-top: 0.5rem; display: flex; justify-content: space-between; color: var(--muted);">
        ...
        <span style="font-weight: 700;"><?php echo e(strtoupper($transacoes->first()->forma_pagamento)); ?></span>
      </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Mariana\Documents\Faculdade\TCC\AtivoTCC\resources\views/financeiro/nota.blade.php ENDPATH**/ ?>