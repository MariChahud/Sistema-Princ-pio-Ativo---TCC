    ...
    <form method="POST" action="<?php echo e(route('receitas.pesagem.confirmar', $receita)); ?>">
      ...
      <div class="card-content" style="padding-top:1.5rem;">
        ...
        <?php $__currentLoopData = $receita->itens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php $pesoAlvo = round(($item->dosagem_mg * $receita->qtd_capsulas) / 1000, 4); ?>
          <div style="background:var(--card);border:1px solid var(--border);border-radius:var(--radius);padding:1rem;margin-bottom:1rem;display:grid;grid-template-columns:2fr 1fr 1fr;gap:1.5rem;align-items:center;">
            ...
            <div style="text-align:right;">
              ...
              <strong style="font-size:1.2rem;color:var(--text-dark);"><?php echo e(number_format($pesoAlvo, 4, ',', '.')); ?> g</strong>
            </div>
            <div class="form-group" style="margin:0;">
              <label style="font-size:0.75rem;font-weight:700;color:var(--primary-dark);">Massa Confirmada (g)</label>
              <input type="number" name="peso_real[<?php echo e($item->id); ?>]"
                value="<?php echo e($pesoAlvo); ?>"
