...
<?php $__env->startSection('conteudo'); ?>
  ...
  <div class="grid-2">
    ...
    <div class="card">
      ...
      <div class="card-content">
        <p class="empty-state">O registro de atividades será alimentado pelo backend (ex.: tabela de logs/auditoria).</p>
      </div>
    </div>
  </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Mariana\Documents\Faculdade\TCC\AtivoTCC\resources\views\dashboard.blade.php ENDPATH**/ ?>